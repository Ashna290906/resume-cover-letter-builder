...
const API_KEY = process.env.REACT_APP_GEMINI_API_KEY || 'AIzaSyBDg0u7Ok1ek_0zHVPEIZBqRlDHa-Urtdc';

if (!API_KEY) {
  console.warn('No Gemini API key found. Please set REACT_APP_GEMINI_API_KEY in your environment variables.');
}
